...
namespace Azure.Management.Resources
{
    ...
    public partial class ResourcesOperations
    {
        ...
        internal ResourcesOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2017-05-10")
        {
            RestClient = new ResourcesRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
